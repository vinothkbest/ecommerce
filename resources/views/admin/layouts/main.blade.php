...
<head>
    ...
    <link rel="icon" sizes="180x180" href="{{ asset('web/img/logo.png') }}">

    <!-- Fonts and Styles -->
    @yield('css_before')
    <link rel="stylesheet" id="css-main" href="{{ asset('js/plugins/sweetalert2/sweetalert2.min.css') }}">
    <link rel="stylesheet" id="css-main" href="{{ asset('css/oneui.css') }}">
    <link rel="stylesheet" id="css-main" href="{{ asset('css/theme.css') }}">
...
<body>
    ...
    <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll page-header-fixed">
        @include('admin.layouts._sidemodal')
        ...
        <footer id="page-footer" class="bg-body-light">
            <div class="content py-3">
                <div class="row font-size-sm">
                    <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-right" style="font-size: 12px">
                        Developed by <a class="font-w600" href="http://www.ninositsolution.com" target="_blank">NINOS IT
                            SOLUTION</a>
                    </div>
                    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                        <strong>All Rights Reserved by Kapa Foods Copyright </strong> &copy;<span>2021</span>
                    </div>
                </div>
            </div>
        </footer>
