        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-inline-block ml-2">
                <button type="button" class="btn btn-sm btn-dual d-flex align-items-center"
                    ...
                    <img class="rounded-circle" src="{{ asset('assets/logo.png') }}" alt="Header Avatar"
                        style="width: 21px;">
                    <span class="d-none d-sm-inline-block ml-2">Kapa Foods</span>
                    <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block ml-1 mt-1"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0"
                    aria-labelledby="page-header-user-dropdown">
                    <div class="p-3 text-center bg-primary-dark rounded-top">
                        <img class="img-avatar img-avatar48" src="{{ asset('assets/logo.png') }}" alt="">
                        <p class="mt-2 mb-0 text-white font-w500">Kapa Foods</p>
                        {{-- {{ auth()->user()->username }} --}}
                    ...
                    <div class="p-2">
                        ...
                        <a class="dropdown-item d-flex flex-row align-items-center justify-content-between"
