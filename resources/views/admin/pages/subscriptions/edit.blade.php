...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill h3 my-2">Edit Subscription</h1>
                ...
                <div class="row">
                    <div class="col-md-4 form-group product-add">
                        ...
                        <select class="product-create" name="type">
                            <option value="basic" @selector((old('type')?old('type'):$subscription->type),'basic')>Basic
                            </option>
                            <option value="event" @selector((old('type')?old('type'):$subscription->type),'event')>Event
                            </option>
                        </select>
                        @error('type')
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="add-admin-frm"
                            value="{{ old('name')?old('name'):$subscription->name }}" name="name"
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" class="add-admin-frm"
                            value="{{ old('validity')?old('validity'):$subscription->validity }}" name="validity"
                    ...
                    <div class="col-md-4 form-group">
                        <label>Amount</label>
                        <input type="number" class="add-admin-frm"
                            value="{{ old('amount')?old('amount'):$subscription->amount }}" name="amount"
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="number" class="add-admin-frm"
                            value="{{ old('image_count')?old('image_count'):$subscription->image_count }}"
                            name="image_count" placeholder="ex: 100">
                        @error('image_count')
                        <div class="text-danger animated fadeIn">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <select class="add-admin-frm add-admin-frms" name="status">
                            <option @selector((old('status')?old('status'):$subscription->status),'1') value="1">Active
                            </option>
                            <option @selector((old('status')?old('status'):$subscription->status),'0')
                                value="0">Disabled
                            </option>
                        </select>
                        @error('status')
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="add-admin-frm" style="resize: none" id="example-textarea-input"
                            ...
                            placeholder="Enter detail of this subscription..">{{ old('description')?old('description'):$subscription->description }}</textarea>
                        @error('description')
                        <div class="text-danger animated fadeIn">
