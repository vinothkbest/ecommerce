                          ...
                          <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" class="add-admin-frm" id="category_id">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="sub_category_id" class="add-admin-frm" id="sub_category" required>
                                                <option>--- Select Category---</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="child_sub_category_id" class="add-admin-frm" id="child_sub_category" required>
                                                <option>--- Select Category---</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Product</label>
                                            <input type="text" name="product_name" class="add-admin-frm" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                           <label>GST Tax (In %)</label>
                                            <input type="number"
                                                   name="gst_tax" class="add-admin-frm"
                                                   pattern="[0-9]+([\.,][0-9]+[0-9])" step="0.01"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="add-admin-frm" name="product_description" rows="5" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          name="detailed_description" placeholder="Content"></textarea>
                    ...
                    <div class="card mt-3">
                          ...
                          <div class="card-body">
                                <div id="more_variants">
                                    <div class="row rows-class">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>variant</label>
                                                <input type="text" class="add-admin-frm" name="variants[0][variant_name]" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Unit</label>
                                                <select class="add-admin-frm add-admin-frms" name="variants[0][unit_id]">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="add-admin-frm" name="variants[0][availability_count]" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Actual Price</label>
                                                <input type="text" class="add-admin-frm" name="variants[0][actual_price]" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Discount</label>
                                                <input type="text" class="add-admin-frm" name="variants[0][discount_price]" required>
                                            </div>
                                        </div>
                                    </div>
