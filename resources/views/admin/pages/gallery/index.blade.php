...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill h3 my-2">Gallery List</h1>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="block-header add-btn">
                    <a href="{{ route('admin.galleries.create') }}"><i class="fas fa-plus"></i>Add Gallery</a>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-w600 font-size-sm">X man</td>
                        <td class="font-w600 font-size-sm">Gallery Image</td>
                        <td>
                            <img src="{{ asset('image/thumbnail-img.jpg') }}" alt="" style="width: 25%;">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="font-w600 font-size-sm">X man</td>
                        <td class="font-w600 font-size-sm">Gallery Video</td>
                        <td>
                            <img src="{{ asset('image/video-thumb.jpg') }}" alt="" style="width: 25%;">
                        </td>
                        <td>
                            <a href="#" class="badge badge-success">Active</a>
                            <a href="#" class="badge badge-danger">Disable</a>
