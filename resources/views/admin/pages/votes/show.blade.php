                ...
                <div class="col-lg-12">
                    <div class="block block-rounded">
                        <table class="table table-borderless voting-amt">
                            <thead>
                                <tr class="block-header-default">
                                    <th colspan="3" class="block-title">Voting Details</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td style="width: 40%;">Best Film</td>
                                    <td>: </td>
                                    <td>10000 </td>
                                </tr>
                                <tr>
                                    <td style="width: 40%;">Best Actor</td>
                                    <td>: </td>
                                    <td>20000</td>
                                </tr>
                                <tr>
                                    <td style="width: 40%;">Best Actress</td>
                                    <td>: </td>
                                    <td>5000</td>
                                </tr>
                                <tr>
                                    <td style="width: 40%;">Best Cinematographer</td>
                                    <td>: </td>
                                    <td>15000</td>
                                </tr>
                                <tr>
                                    <td style="width: 40%;">Best Editor</td>
                                    <td>: </td>
                                    <td>20000</td>
                                </tr>
                                <tr>
                                    <td style="width: 40%;">Best Music Director</td>
                                    <td>: </td>
                                    <td>15000</td>
                                </tr>
                                <tr>
                                    <td style="width: 40%;">Best Story & Screenplay</td>
                                    <td>: </td>
                                    <td>15000</td>
                                </tr>
                                <tr class="total-amt">
                                    <td style="width: 40%;"><strong>Total Votings</strong></td>
                                    <td>: </td>
