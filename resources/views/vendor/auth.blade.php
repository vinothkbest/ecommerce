...
<div class="hero-static">
            ...
            <div class="col-md-8 col-lg-6 col-xl-4">
                ...
                <div class="block block-rounded block-themed mb-0 border" style="border-color: #bfbebe !important;">
                    <div class="block-header bg-primary-dark text-center"
                        ...
                        <img src="{{ asset('images/logo-512.png') }}" width="100px" style="margin: 0 auto" alt="">
                    </div>
                    <div class="block-content">
                        <div class="p-sm-3 px-lg-4 py-lg-5">
                            <h1 class="h2 mb-1">Login</h1>
                            <form class="js-validation" action="{{ route('vendor.login.verify') }}" method="POST">
                                {{ csrf_field() }}
                                <div class="py-3">
    ...
    <div class="content content-full font-size-sm text-muted text-center">
        <strong>All Rights Reserved by Yellowrider Copyright</strong> &copy; <span> at 2019-2020</span>
    </div>
</div>
@endsection
